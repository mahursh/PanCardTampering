...
app.config["GENERATED_FILED"]= "app/static/generated"
...
def index():
    ...
    if request.method == "POST":
        ...
        cv2.imwrite(os.path.join(app.config["GENERATED_FILED"], "image_original.jpg"), original_image)
        cv2.imwrite(os.path.join(app.config["GENERATED_FILED"], "image_uploaded.jpg"), uploaded_image)
        cv2.imwrite(os.path.join(app.config["GENERATED_FILED"], "image_diff.jpg"), diff)
        cv2.imwrite(os.path.join(app.config["GENERATED_FILED"], "image_thresh.jpg"), thresh)
